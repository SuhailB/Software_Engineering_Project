...
public class MapsActivity
    ...
    private static String PermitType = "default";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PermitType = intent.getStringExtra(Intent.EXTRA_TEXT);
